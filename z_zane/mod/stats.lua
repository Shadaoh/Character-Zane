...
alpha:addCostume("zanehair.anm2")
--[[
...
alpha:addItem(CollectibleType.COLLECTIBLE_20_20, true) -- I want Sad Onion and give me the costume.
--[[
  For every item you want to add to your character repeat this line.
  character:AddItem(ItemID, true)
...
alpha:setTrinket(TrinketType.TRINKET_CRACKED_DICE)
--[[
...
alpha:setPocketItem(PillEffect.PILLEFFECT_BAD_TRIP, true)
--[[
...
normalStats.Firedelay = 2.00
normalStats.Shotspeed = 0.75
normalStats.Range = 10.50
